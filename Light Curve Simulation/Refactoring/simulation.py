...
# Imports
from Refactoring import phasefolded
from Refactoring.help_functions import *
from Refactoring.phasefolded import *
...
class Simulate():
    """
    Class for apply the modeling created by Mandel & Agol (2008).
    """
    ...
    def simulate_lightcurve(self, observed_curve=None, b_impact=None, p=None, period=None, adivR=None, x_values=None) -> phasefolded.PhaseFoldedLightCurve:
        """
        Parameters
        ----------
        observed_curve : numpy ndarray
        ...
        phasefoldedobject = phasefolded.PhaseFoldedLightCurve(original_time=observed_curve[:, 0], original_flux=observed_curve[:, 1], simulated_time=simulated_curve[:, 0], simulated_flux=simulated_curve[:, 1], chi2=chi2)

        return phasefoldedobject

    
    def simulate(self, observed_curve, b_impact, p, period, adivR, x_values):
        flux = []
